    ...
    return (
        <AdminLayout>
            <div className="flex items-center justify-between mb-8">
                ...
                <Link to="/admin/products/new" className="bg-primary text-white px-6 py-3 rounded-xl font-bold shadow-lg shadow-primary/20 hover:brightness-110 transition-all flex items-center gap-2">
