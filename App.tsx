      ...
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-16">
        <div className="col-span-1 md:col-span-2 flex flex-col gap-6">
          ...
          <div className="flex gap-4">
            {/* Instagram */}
            <a href="https://www.instagram.com/sitelang_/" target="_blank" rel="noopener noreferrer" className="size-11 rounded-2xl bg-slate-50 flex items-center justify-center text-[#795e8d] hover:bg-gradient-to-tr hover:from-purple-500 hover:via-pink-500 hover:to-orange-500 hover:text-white transition-all shadow-sm group">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="group-hover:stroke-white transition-colors">
            ...
            {/* Facebook */}
            <a href="#" className="size-11 rounded-2xl bg-slate-50 flex items-center justify-center text-[#795e8d] hover:bg-[#1877F2] hover:text-white transition-all shadow-sm group">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="group-hover:stroke-white transition-colors">
            ...
            {/* WhatsApp */}
            <a href="https://wa.me/6285229312990" target="_blank" rel="noopener noreferrer" className="size-11 rounded-2xl bg-slate-50 flex items-center justify-center text-[#795e8d] hover:bg-[#25D366] hover:text-white transition-all shadow-sm group">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="group-hover:stroke-white transition-colors">
